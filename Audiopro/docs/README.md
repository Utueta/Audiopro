...
**Version:** 0.3.1 (Sentinel)  
**Architecture:** Asynchronous Hexagonal Pipeline  
**Hashing:** Blake2b (v0.3.1 Standard)
---
...
## 1. System Overview
Audiopro v0.3.1 "Sentinel" introduces a tri-tier arbitration logic. 
- **Tier 1**: Deterministic DSP feature extraction.
- **Tier 2**: Random Forest classification (Local).
- **Tier 3**: AI Arbitration (LLM) for scores between 0.35 and 0.75.

## 2. Infrastructure
- **Database**: `audiopro_v03.db` (SQLite WAL Mode).
- **AI Service**: Ollama/Qwen 2.5 local bridge.
